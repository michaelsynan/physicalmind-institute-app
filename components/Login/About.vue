...
<template>
  <div>
    <p class="mb-2 text-black !text-2xl">
      This app is for those who own a TYE4® or Tye4X™ with BLACK BUNGEES. Don't have one? Buy it ASAP because this
      product is your passport to FREE Content: access to a $140.00
    ...
    <p class="mb-4 !text-2xl text-black pt-2">
